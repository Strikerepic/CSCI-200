...
public:
    ...
    /**
     * @brief perform the recursive Merge Sort algorithm
     * 
     */
    virtual void sort() = 0;
    ...
    /**
     * @brief This function will need to be implemented as both Array::search(T) 
     * and LinkedList::search(T). The Array implementation will use binary search
     *  while the LinkedList implementation will use linear search.
     * 
     */
